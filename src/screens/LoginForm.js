...
import { Button, CustomText, Logo, Input, Spinner, Notification } from "../components/common";
...
export default class LoginForm extends Component {
  ...
  render() {
    ...
    // const { container, cardContainer, footerStyle, buttonTextStyle, buttonStyle, signUpTextStyle } =
    //   styles;
    // return (
    ...
    //               <CustomText style={{ color: "#ffff" }}>Don't have an account? </CustomText>
    ...
    //     <Button onPress={this.showactivityIndicator.bind(this)}>Open spinner</Button>
    //     {this.renderNotification()}
    //   </LinearGradient>
    // );
  }
