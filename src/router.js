...
const TabNavigator = createBottomTabNavigator(
  {
    Inbox: {
      ...
      navigationOptions: () => ({
        tabBarLabel: "INBOX",
        tabBarIcon: ({ tintColor }) => <Icon name="ios-mail-open" color={tintColor} size={22} />,
      }),
    },
    Users: {
      screen: MainStack,
      navigationOptions: () => ({
        tabBarLabel: "USERS",
        tabBarIcon: ({ tintColor }) => <Icon name="ios-contacts" color={tintColor} size={22} />,
      }),
    },
    Settings: {
      screen: Settings,
      navigationOptions: () => ({
        ...
        tabBarIcon: ({ tintColor }) => <Icon name="ios-cog" color={tintColor} size={22} />,
      }),
    },
  },
  {
